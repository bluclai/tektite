...
>
    ...
    {#if platformStore.value === 'macos'}
        ...
        <div class="relative z-10 flex items-center gap-1.5 pl-3" role="presentation">
            ...
            >
                <svg class="opacity-0 transition-opacity duration-200 group-hover:opacity-100" width="6" height="6" viewBox="0 0 6 6" fill="none">
            ...
            >
                <svg class="opacity-0 transition-opacity duration-200 group-hover:opacity-100" width="6" height="2" viewBox="0 0 6 2" fill="none">
    ...
    {:else}
        ...
        <div class="absolute inset-y-0 right-0 z-10 flex items-center" role="presentation">
            <button
                ...
                aria-label="Minimize window"
                title="Minimize"
                class="flex h-full w-[46px] cursor-default items-center justify-center text-on-surface-variant transition-colors duration-200 ease-out hover:bg-surface-container-high"
            >
            ...
            <button
                ...
                aria-label="Close window"
                title="Close"
                class="flex h-full w-[46px] cursor-default items-center justify-center text-on-surface-variant transition-colors duration-200 ease-out hover:bg-[#c42b1c] hover:text-white"
            >
                <svg width="10" height="10" viewBox="0 0 10 10" fill="none">
